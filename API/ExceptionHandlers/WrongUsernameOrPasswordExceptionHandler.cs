...
{
    public class WrongUsernameOrPasswordExceptionHandler : IExceptionHandler
    {
        public bool CanHandle(Exception exception) => exception is WrongUsernameOrPasswordException;
